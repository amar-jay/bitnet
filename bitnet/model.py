"""
A manipulation of nanogpt to use BitLinear layer as a drop-in replacement for Linear layer.
from:
...
class GPT(nn.Module):
    ...
    def from_pretrained(cls, model_type, override_args=None):
        ...
        config.linear_batch_groups = 4 # always 4 for GPT model checkpoints
